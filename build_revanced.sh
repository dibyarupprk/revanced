...
# Uncomment and modify the following line to set different patches -i shorts-button
 available_patches="-i codecs-unlock -i exclusive-audio-playback -i tasteBuilder-remover -i upgrade-button-remover -i background-play -i general-ads -i video-ads -i seekbar-tapping -i amoled -i premium-heading -i disable-create-button -i minimized-playback -i old-quality-layout -i microg-support -i hide-cast-button"
